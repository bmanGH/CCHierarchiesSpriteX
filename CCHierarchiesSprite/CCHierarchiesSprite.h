...
#define HIERARCHIES_SPRITE_RUNTIME_VERSION "0.42x"


NS_CC_EXT_BEGIN

class CC_DLL CCHierarchiesSprite : public CCNodeRGBA, public CCTextureProtocol {
...
public:
	...
	CC_SYNTHESIZE_READONLY(CCHierarchiesSpriteMesh*, _mesh, Mesh) // copy on write with avatar
...
public:
	...
	bool setSpriteFile (const char* sheetFileName,
                        const char* animationFileName);
    bool setSpriteFile (const char* sheetFileName,
                        const char* animationFileNameBase,
                        const char* animationFileNameSub);
